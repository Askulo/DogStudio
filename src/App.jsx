 ...
 return (
  ...
  <section id="section-1">
    <nav>
      ...
      <div className='nav-elem'><i className="ri-menu-3-fill "></i></div>
    </nav>
  ...
  <section id="section-3">
    <div className="top">
      <div className="left">
        <h3>Lorem ipsum dolor <br/> sit amet consectetur <br/> adipisicing elit. <br/> Provident, non?</h3>
      </div>
    ...
    <div className="bottom">
      ...
      <div className="right  z-10">
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae laborum architecto consequuntur minima inventore vero libero suscipit vel neque sint. Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, tenetur.</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae laborum architecto consequuntur minima inventore vero libero suscipit vel neque sint. Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, tenetur.</p>
